...
from database import init_db, update_tickers_from_source, get_tickers_by_category, get_tickers_by_categories, prune_old_tickers
...
def get_all_existing_tickers():
    ...
    return set(get_tickers_by_categories(categories))
